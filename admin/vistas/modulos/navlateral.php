...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php  echo SERVERURL;?>home/">
    <div class="sidebar-brand-icon">
      <img src="<?php  echo SERVERURL;?>vistas/images/general/huellas.jpg">
    </div>
    <div class="sidebar-brand-text mx-3">Veterinaria<sup>HF</sup></div>
  </a>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInventario" aria-expanded="true" aria-controls="collapseInventario">
      <img src="<?php  echo SERVERURL;?>/img/servicio.png" alt="inventario" width="30"></i>
      <span>Servicios</span>
    </a>
    <div id="collapseInventario" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="py-2 collapse-inner rounded">
        <a class="collapse-item" href="<?php  echo SERVERURL;?>addProdservi/">      <img src="<?php  echo SERVERURL;?>/img/servicio.png" alt="inventario" width="30"></i> Nuevo Servicio</a>
        <a class="collapse-item" href="<?php  echo SERVERURL;?>listaProdservi/">      <img src="<?php  echo SERVERURL;?>/img/servicio.png" alt="inventario" width="30"></i> Lista Servicio</a>
      </div>
    </div>
  </li>
