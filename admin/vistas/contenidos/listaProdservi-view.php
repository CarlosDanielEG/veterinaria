<div class="titulo-linea mt-2">
  <h2><i class="fas fa-box-open"></i>Lista Servicios</h2>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="float-right">
                ...
                <a href="<?php  echo SERVERURL;?>addProdservi" class="btn btn-primary btn-sm mb-2"><i class="fas fa-plus mr-2"></i>Nuevo Servicio</a>  
              </div>
            </div>
          </div>
        </div>
