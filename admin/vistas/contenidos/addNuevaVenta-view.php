            ...
            <div class="d-flex flex-column float-right">
              ...
              <div>
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="radio1">Boleta</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
            ...
            <div class="venta-footer d-flex flex-row justify-content-between">
              <div class="mt-4">
                ...
                <div class="tipo-pago d-flex flex-wrap">
                  ...
                  <label for="venta-yape" class="d-flex flex-column">
                    <input type="radio" name="venta_pago_reg" class="pago-item" id="venta-yape" value="Yape" />
                    Yape
                    <img src="<?php echo SERVERURL; ?>vistas/images/general/yape-logo.png" alt="Yape" style="width: 24px; height: 24px;">
                  </label>
                </div>
